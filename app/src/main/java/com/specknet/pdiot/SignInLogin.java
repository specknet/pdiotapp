...
public class SignInLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_login);
         ...
         moveToRegister=new Intent(this, SignInRegister.class);
    ...
    private void loginUser(final String email, final String password)
    {
        FirebaseAuth.getInstance().signInWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                Toast.makeText(SignInLogin.this, "Login successful!",
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SignInLogin.this, "Login failed!"+e.getMessage(),
